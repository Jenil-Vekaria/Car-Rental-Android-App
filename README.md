...
Android mobile app which simulates Car Rental<br>
...
However, I wanted it take it bit furthur and decided to build a mobile app for, so here are the pictures below of my mobile app concept.
<br><br>
This app has a login page where users can sign up. Once logged in, you can choose any car category you like. You will then be directed to another page where all the available car for that category is display along with the daily rate. If you wish, you can book a car with all your personal information and do necessary payment. Once you have paid, your booking is finally complete. Now you view all your bookings, or return the car or browse through all the car. 
